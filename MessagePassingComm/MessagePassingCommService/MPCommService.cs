...
// Source:Jim Fawcett, CSE681 Software Modelling and Analysis       //
...
namespace MessagePassingComm
{
    ...
    public class Receiver : IMessagePassingComm
    {
        ...
        public bool openFileForWrite(string name, int childProc, string folderName)
        {

            try
            {
                string path = System.IO.Path.Combine(ServiceEnvironment.fileStorage, ("Builder" + childProc), folderName);
                 if (!Directory.Exists(path))
                    Directory.CreateDirectory(path);

                string writePath = Path.Combine(path, name);
                Console.Write("\n\n===================================================================================\n\n");
                Console.Write("\n Write path is {0}", System.IO.Path.GetFullPath(writePath));
                Console.Write("\n\n===================================================================================\n\n");
    ...
    public class Sender
    {
        ...
        public bool postFile(string fileName, int childProc, string folderName)
        {
            ...
            try
            {
                ...
                Console.Write("\n\n===================================================================================\n\n");
                Console.Write("\n \n Read path is {0}", System.IO.Path.GetFullPath(path));
                Console.Write("\n\n===================================================================================\n\n");
                fs = File.OpenRead(path);
                bytesRemaining = fs.Length;
                channel.openFileForWrite(fileName, childProc, folderName);
                while (true)
                {
